...
-- Tabela de exemplares (cópias físicas de um livro)
...
-- Empréstimo agora referencia um exemplar específico
...
CREATE TABLE IF NOT EXISTS classificacao (
    ...
    FOREIGN KEY (idAluno) REFERENCES aluno(id),
    UNIQUE KEY uniq_classificacao_semestre_aluno (idSemestre, idAluno)
);
